...
NEXT_PUBLIC_SITE_NAME="Kojosropa"
NEXT_PUBLIC_SITE_TAGLINE="Curated shirts, one of one."
NEXT_PUBLIC_SITE_DESCRIPTION="Kojosropa is a curated shirt shop from Accra. Graphic tees, deadstock blanks and soft-worn classics — one of one, and never restocked."
NEXT_PUBLIC_SITE_KEYWORDS="vintage shirts,graphic tees,curated shirts,one of one,Accra,Ghana"
NEXT_PUBLIC_CONTACT_EMAIL="${EMAIL:-hello@example.com}"
NEXT_PUBLIC_INSTAGRAM_HANDLE="@kojosropa"
NEXT_PUBLIC_FREE_DELIVERY_THRESHOLD=300
NEXT_PUBLIC_DELIVERY_FEE=30
